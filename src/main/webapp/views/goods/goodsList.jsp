            ...
            <div class="templatemo-flex-row flex-content-row">
                <div class="col-1">
                        <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                            ...
                            <div class="panel-heading templatemo-position-relative"><h2 class="text-uppercase">货物列表</h2></div>
                    ...
                    <div class="pagination-wrap">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/goods/goodsPageList?first=1">1</a></li>
                            <c:forEach items="${pageSize}" var="page">
                                <li><a href="${pageContext.request.contextPath}/goods/goodsPageList?first=${page}">${page}</a></li>
                            </c:forEach>
                        </ul>
                    </div>
