...
<div class="templatemo-content-container light-gray-bg" style="height: 900px">
    <div class="templatemo-content-widget white-bg">
        ...
        <h2 class="templatemo-inline-block">&nbsp;个人中心</h2><hr>
                <label>用户ID：${user.userId}</label>
        &emsp;&emsp;&emsp;  <label >用户账号：${user.userName}</label><br>
            <%--<label>用户ID：<input type="text" id="userId" class="mine" name="userId" placeholder="" value="${user.userId}" disabled></label>--%>
            <%--&emsp;&emsp;&emsp;<label >用户账号：<input type="text" id="userName" class="mine" name="userName" placeholder="" value="${user.userName}"></label><br>--%>
        <form class="templatemo-login-form" method="post" enctype="multipart/form-data">
            <div class="row form-group has-success">
                <div class="col-lg-6 col-md-6 form-group">
                    <label>用户姓名</label>
                    <input type="text" class="form-control" id="realName" name="realName" placeholder="" value="${user.realName}">
                </div>
                <div class="col-lg-6 col-md-6 form-group">
                    <label>联系电话</label>
                    <input type="text" class="form-control" id="phoneNumber" name="phoneNumber" placeholder="" value="${user.phoneNumber}">
                </div>
            </div>
            ...
            <div class="row form-group has-success">
                ...
                <div class="col-lg-6 col-md-6 form-group">
                    <label >身份证号</label>
                    <input type="text" class="form-control" id="identity_number" name="identity_number" placeholder="" value="${user.identityNumber}">
                </div>
            </div>
            ...
            <div class="row form-group has-success">
                ...
                <div class="col-lg-6 col-md-6 form-group">
                    <label >用户备注</label>
                    <input type="text" class="form-control" id="remark" name="remark" placeholder="" value="${user.remark}">
                </div>
            </div>
